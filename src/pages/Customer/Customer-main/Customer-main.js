    ...
    return (
        <div>
           ...
           <Card className="Card-customer">
               ...
               <p className="customer-page-info">This is the Customer Page<br/>
               Here the customer can view profile.<br/>Customer can also update profile and view order wheather they are accept or reject  </p>
                </Card>
<img className="customer-profile-img" src={viewCustomerProfile} alt="viewCustomerProfile"/>
<Link to="customer-profile"><p  className="view-customer-profile">View Customer Profile</p></Link>
<img className="update-profile-img" src={updateCustomerProfile} alt="updateCustomerProfile"/>
<Link to="/customer-update-profile"><p className="update-cus-profile" >Update Profile</p></Link>
<img className="viewOrder" src={viewOrder} alt="viewOrder"/>
<Link to="/customer-orders"><p className="view-orders-cus">View Orders</p></Link>
