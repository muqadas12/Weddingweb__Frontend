...
function DealerMain() {
  ...
  return (
    <div>
      ...
      <img src={dealerdashboardpic} className="dealer-main-page-img" alt="dealerdashboardImg"/>
      
     
      <img className="view-profile-dealer-main-page"   src={dealerProfile} alt="ViewProfile"/>
     <Link to="/dealer-view-profile"> <p className="Link-to-profile-page">View Profile</p></Link>
     <img className="update-profile-dealer" src={updateProfile} alt="update-profile"/>
     <Link to="/dealer-update-profile"><p className="link-to-update-profile">Update Profile</p></Link>
     <img src={addServices} className="add-services-dealer-page" alt="addServices"/>
     <Link to="/dealer-add-services"><p className="Link-to-add-services-page">Add Services</p></Link>
     <img className="view-services-dealer" src={viewServices} alt="viewServices"/>
     <Link to="/dealer-view-services"><p className="Link-to-view-services-page">View Services</p></Link>
