...
//         <input onChange={(e)=>handleChange(e)}  id="name" value={data.name} type="text" placeholder="name"/>

//             <input onChange={(e)=>handleChange(e)} id="email" value={data.email}  type="text" placeholder="email" />
//             <input onChange={(e)=>handleChange(e)}  id="password" value={data.password} type="text" placeholder="passord"/>
//             <select id="role" name="role" onChange={(e)=>handleChange(e)} value={data.role} >
//               <option   name="customer">Customer</option>
//               <option   name="customer">Customer</option>
//               <option   name="dealer">Dealer</option>
